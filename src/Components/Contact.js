              ...
              <ContactBox>
                <Typography
                  ...
                  style={{
                    ...
                    padding: "5px",
                    borderRadius: "7px", // Set the border radius
                    display: "inline-block", // Ensure the text is on a single line
                  }}
                >
                  ADDRESS
                </Typography>
                ...
                <Typography
                  ...
                  style={{
                    ...
                    padding: "5px",
                    borderRadius: "7px", // Set the border radius
                    display: "table", // Ensure the text is on a single line
                  }}
                >
                  EMAIL
                </Typography>
                <Link
                  href="mailto:maazy2009@gmail.com"
                  color="secondary"
                  style={{ color: "#ffffff" }}
                >
                  Maazy2009@gmail.com
